...
class CKParser(BaseParser):
    ...
    def _define_fields(self) -> List[FieldDef]:
        ...
        return [
            ...
            FieldDef("NigeCount", 1369, 3, convert_type="SMALLINT", description="脚質傾向・逃げ回数"),
            FieldDef("SenkoCount", 1372, 3, convert_type="SMALLINT", description="脚質傾向・先行回数"),
            FieldDef("SashiCount", 1375, 3, convert_type="SMALLINT", description="脚質傾向・差し回数"),
            FieldDef("OikomiCount", 1378, 3, convert_type="SMALLINT", description="脚質傾向・追込回数"),
